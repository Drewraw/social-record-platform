...
import { Star, Users, MessageSquare, Grid3x3 } from 'lucide-react';
...
const Homepage = () => {
  ...
  const [activeTab, setActiveTab] = useState('browse'); // 'browse' or 'chat'
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f9fafb' }}>
        ...
        <div style={{ 
          ...
          <button
            ...
            style={{
              ...
              background: 'none',
              border: 'none',
              borderBottom: activeTab === 'browse' ? '3px solid #667eea' : '3px solid transparent',
              color: activeTab === 'browse' ? '#667eea' : '#6b7280',
              fontWeight: 600,
              fontSize: '1rem',
              cursor: 'pointer',
              display: 'flex',
      ...
      {activeTab === 'chat' ? (
        ...
        // Original Browse Officials Content
        <>
        {/* Category Filter Cards */}
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 1.5rem', marginTop: '1.5rem' }}>
